...
public class conversor_temperatura {
	public void obtener_datos() {
		...
		Object opciones_elegir_temperatura = JOptionPane.showInputDialog(null,"Seleccione una opción de conversión", "Menu",JOptionPane.QUESTION_MESSAGE,null,opciones_temperatura, opciones_temperatura[0]);
